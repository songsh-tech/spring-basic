...
// @Controller: 해당 클래슥가 HTML 형태의 ResponseBdoy를 반환하는 Controller임을 명시
...
public class BasicController {
  ...
  // GET http://localhast:8080/basic/first
  ...
  // @PatchMapping : RequestMapping에 PATCH에 한정시킨 어노테이션
